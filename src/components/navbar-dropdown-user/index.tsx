...
Ele imprime as iniciais do usuário na tela, mas em uma implementação real, caberia inserir um avatar.
*/
...
export function DropDownUser() {
  const t = useTranslations("components.navbar-dropdown-user");
